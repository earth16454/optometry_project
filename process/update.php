...
if (isset($_REQUEST['submit'])) {
  ...
  try {
    ...
    $sql3 = "UPDATE pohx SET POHx_checked = :POHx_checked, 
      POHx_reason = :POHx_reason, 
      POHx_inspector = :POHx_inspector, 
      POHx_site = :POHx_site, 
      POHx_mydriatic = :POHx_mydriatic, 
      POHx_results = :POHx_results, 
      POHx_edited = :POHx_edited, 
      POHx_radio = :POHx_radio, 
      POHx_radio_detail = :POHx_radio_detail
      WHERE pi_id = :pi_id
    ";
    ...
    $sql5 = "UPDATE pmhx SET PMHx_checked = :PMHx_checked,
      PMHx_reason = :PMHx_reason, 
      PMHx_inspector = :PMHx_inspector, 
      PMHx_site = :PMHx_site, 
      PMHx_results = :PMHx_results, 
      PMHx_pressure = :PMHx_pressure, 
      PMHx_sugar = :PMHx_sugar, 
      PMHx_disease = :PMHx_disease
      WHERE pi_id = :pi_id
    ";
    ...
    $sql6 = "UPDATE medication SET
      med_radio = :med_radio, med_radio_detail = :med_radio_detail, med_KKK = :med_KKK WHERE pi_id = :pi_id 
    ";
    ...
    $sql7 = "UPDATE fmhx SET FmHx_text = :FmHx_text WHERE pi_id = :pi_id";
    ...
    $sql8 = "UPDATE ohe SET
      ohe_work = :ohe_work, 
      ohe_hobby = :ohe_hobby, 
      ohe_checkbox1 = :ohe_checkbox1, 
      ohe_checkbox_detail1 = :ohe_checkbox_detail1, 
      ohe_checkbox2 = :ohe_checkbox2, 
      ohe_checkbox_detail2 = :ohe_checkbox_detail2, 
    ...
    $sql9 = "UPDATE patient_response SET pr_radio = :pr_radio, pr_other = :pr_other WHERE pi_id = :pi_id";
    ...
    $sql10 = "UPDATE old_Rx SET 
      old_Rx = :old_Rx, 
      old_Rx1_od = :old_Rx1_od, 
      old_Rx1_os = :old_Rx1_os, 
      old_Rx1_add = :old_Rx1_add, 
      old_Rx1_pd = :old_Rx1_pd,
      old_Rx2_od = :old_Rx2_od,
      old_Rx2_os = :old_Rx2_os,
      old_Rx2_add = :old_Rx2_add,
      old_Rx2_pd = :old_Rx2_pd,
      old_VAsc_distance_od = :old_VAsc_distance_od,
      old_VAsc_distance_os = :old_VAsc_distance_os, 
      old_VAsc_distance_ou = :old_VAsc_distance_ou, 
      old_VAsc_pinhole_od = :old_VAsc_pinhole_od, 
      old_VAsc_pinhole_os = :old_VAsc_pinhole_os, 
      old_VAsc_near_od = :old_VAsc_near_od, 
      old_VAsc_near_os = :old_VAsc_near_os, 
      old_VAsc_near_ou = :old_VAsc_near_ou, 
      old_VAcc_distance_od = :old_VAcc_distance_od, 
      old_VAcc_distance_os = :old_VAcc_distance_os, 
      old_VAcc_distance_ou = :old_VAcc_distance_ou, 
      old_VAcc_pinhole_od = :old_VAcc_pinhole_od, 
      old_VAcc_pinhole_os = :old_VAcc_pinhole_os, 
      old_VAcc_near_od = :old_VAcc_near_od, 
      old_VAcc_near_os = :old_VAcc_near_os, 
      old_VAcc_near_ou = :old_VAcc_near_ou
      WHERE pi_id = :pi_id
    ";
    ...
    $sql11 = "UPDATE preliminary_exam SET
      ...
      pe_aa_os = :pe_aa_os, 
      pe_npc = :pe_npc, 
      pe_motility = :pe_motility,
      pe_con = :pe_con, 
      pe_cover_distance = :pe_cover_distance, 
      pe_cover_near = :pe_cover_near, 
      pe_cover_dots = :pe_cover_dots, 
      pe_so_near = :pe_so_near, 
      pe_so_type = :pe_so_type, 
      pe_color_od = :pe_color_od, 
      pe_color_os = :pe_color_os, 
      pe_color_type = :pe_color_type, 
      pe_grid = :pe_grid, 
      pe_grid_od = :pe_grid_od, 
      pe_grid_os = :pe_grid_os, 
      pe_grid_time = :pe_grid_time 
      WHERE pi_id = :pi_id
    ";
    ...
    $sql12 = "UPDATE refraction SET
      ref_km_od = :ref_km_od, 
      ref_km_os = :ref_km_os, 
      ref_sr_od = :ref_sr_od, 
      ref_sr_od_va = :ref_sr_od_va, 
      ref_sr_os = :ref_sr_os, 
      ref_sr_os_va = :ref_sr_os_va, 
      ref_sr_ou_va = :ref_sr_ou_va, 
      ref_dr_od = :ref_dr_od, 
      ref_dr_od_va = :ref_dr_od_va, 
      ref_dr_os = :ref_dr_os, 
      ref_dr_os_va = :ref_dr_os_va, 
      ref_dr_ou_va = :ref_dr_ou_va, 
      ref_ms_od = :ref_ms_od, 
      ref_ms_od_va = :ref_ms_od_va, 
      ref_ms_os = :ref_ms_os, 
      ref_ms_os_va = :ref_ms_os_va, 
      ref_ms_ou_va = :ref_ms_ou_va, 
      ref_bs_od = :ref_bs_od, 
      ref_bs_os = :ref_bs_os, 
      ref_bs_ou_va = :ref_bs_ou_va 
      WHERE pi_id = :pi_id
    ";
    ...
    $sql13 = "UPDATE binocular_vission SET
      bv_distance_h = :bv_distance_h,
      bv_distance_bi = :bv_distance_bi,
      bv_distance_bo = :bv_distance_bo,
      bv_distance_vertical = :bv_distance_vertical,
      bv_distance_supra = :bv_distance_supra,
      bv_distance_infra = :bv_distance_infra,
      bv_near_radio = :bv_near_radio,
      bv_near_h = :bv_near_h,
      bv_near_bi = :bv_near_bi,
      bv_near_bo = :bv_near_bo,
      bv_near_vertical = :bv_near_vertical,
      bv_near_supra = :bv_near_supra,
      bv_near_infra = :bv_near_infra,
      bv_cal_radio = :bv_cal_radio,
      bv_cal_nra = :bv_cal_nra,
      bv_cal_pra = :bv_cal_pra,
      bv_cal_bcc = :bv_cal_bcc,
      bv_cal_gradients = :bv_cal_gradients,
      bv_cal_calculate_aca = :bv_cal_calculate_aca,
      bv_cal_calculate = :bv_cal_calculate,
      bv_af_od = :bv_af_od,
      bv_af_os = :bv_af_os,
      bv_af_ou = :bv_af_ou,
      bv_af_method = :bv_af_method,
      bv_vf_ou = :bv_vf_ou,
      bv_vf_method = :bv_vf_method,
      bv_maddox = :bv_maddox,
      bv_assoiate = :bv_assoiate,
      bv_prd = :bv_prd,
      bv_ta = :bv_ta,
      bv_ta_rang = :bv_ta_rang
      WHERE pi_id = :pi_id
    ";
    ...
    $sql15 = "INSERT INTO slit_lamp(
      ...
      as_conjunctiva_os = :as_conjunctiva_os, 
      as_sclera_od = :as_sclera_od, 
      as_sclera_os = :as_sclera_os,
      as_cornea_od = :as_cornea_od, 
      as_cornea_os = :as_cornea_os, 
      as_tear = :as_tear, 
      as_tear_od = :as_tear_od, 
      as_tear_os = :as_tear_os, 
      as_iris_od = :as_iris_od, 
      as_iris_os = :as_iris_os,
      as_lens_od = :as_lens_od, 
      as_lens_os = :as_lens_os, 
      as_anterior_od = :as_anterior_od, 
      as_anterior_os = :as_anterior_os, 
      as_p_size_l_od = :as_p_size_l_od, 
      as_p_size_l_os = :as_p_size_l_os,
      as_p_size_d_od = :as_p_size_d_od, 
      as_p_size_d_os = :as_p_size_d_os, 
      as_p_direct_od = :as_p_direct_od, 
      as_p_direct_os = :as_p_direct_os, 
      as_p_consensual_od = :as_p_consensual_od,
      as_p_consensual_os = :as_p_consensual_os, 
      as_p_accommodate_od = :as_p_accommodate_od, 
      as_p_accommodate_os = :as_p_accommodate_os, 
      as_p_marcus_od = :as_p_marcus_od, 
      as_p_marcus_os = :as_p_marcus_os,
      as_img = :as_img, 
      as_assessment = :as_assessment, 
      ps_radio = :ps_radio, 
      ps_media_od = :ps_media_od, 
      ps_media_os = :ps_media_os, 
      ps_vitreous_od = :ps_vitreous_od, 
      ps_vitreous_os = :ps_vitreous_os,
      ps_cd_od = :ps_cd_od, 
      ps_cd_os = :ps_cd_os, 
      ps_disc_od = :ps_disc_od, 
      ps_disc_os = :ps_disc_os, 
      ps_avratio_od = :ps_avratio_od, 
      ps_avratio_os = :ps_avratio_os, 
      ps_avcrossing_od = :ps_avcrossing_od,
      ps_avcrossing_os = :ps_avcrossing_os, 
      ps_macular_od = :ps_macular_od, 
      ps_macular_os = :ps_macular_os, 
      ps_fovea_od = :ps_fovea_od, 
      ps_fovea_os = :ps_fovea_os, 
      ps_bg_od = :ps_bg_od, 
      ps_bg_os = :ps_bg_os,
      ps_periphery_od = :ps_periphery_od, 
      ps_periphery_os = :ps_periphery_os, 
      ps_img = :ps_img, 
      ps_treatment = :ps_treatment, 
      ps_next = :ps_next, 
      ps_examinedby = :ps_examinedby
      WHERE pi_id = :pi_id
    ";
    ...
    $sql16 = "UPDATE prescription SET
      pc_name = :pc_name, 
      pc_age = :pc_age, 
      pc_date = :pc_date, 
      pc_sphere_od = :pc_sphere_od, 
      pc_sphere_os = :pc_sphere_os, 
      pc_cylinder_od = :pc_cylinder_od, 
      pc_cylinder_os = :pc_cylinder_os,
      pc_axis_od = :pc_axis_od, 
      pc_axis_os = :pc_axis_os, 
      pc_add_od = :pc_add_od, 
      pc_add_os = :pc_add_os, 
      pc_prism_od = :pc_prism_od, 
      pc_prism_os = :pc_prism_os, 
      pc_va_od = :pc_va_od, 
      pc_va_os = :pc_va_os,
      pc_pd_od = :pc_pd_od, 
      pc_pd_os = :pc_pd_os, 
      pc_fitting_od = :pc_fitting_od, 
      pc_fitting_os = :pc_fitting_os, 
      pc_checkbox1 = :pc_checkbox1, 
      pc_checkbox_detail1 = :pc_checkbox_detail1, 
      pc_checkbox2 = :pc_checkbox2, 
      pc_checkbox_detail2 = :pc_checkbox_detail2, 
      pc_checkbox3 = :pc_checkbox3, 
      pc_checkbox_detail3 = :pc_checkbox_detail3, 
      pc_checkbox4 = :pc_checkbox4, 
      pc_checkbox_detail4 = :pc_checkbox_detail4, 
      pc_checkbox5 = :pc_checkbox5, 
      pc_checkbox_detail5 = :pc_checkbox_detail5, 
      pc_checkbox6 = :pc_checkbox6, 
      pc_checkbox_detail6 = :pc_checkbox_detail6,
      pc_checkbox7 = :pc_checkbox7, 
      pc_checkbox_detail7 = :pc_checkbox_detail7, 
      pc_note = :pc_note
      WHERE pi_id = :pi_id
      ";
