  ...
  <body>
    <div class="container mt-5" style="max-width: 960px;">
      <form action="" method="post" class="needs-validation" novalidate>
        ...
        <div class="form-check">
          <input class="form-check-input" type="checkbox" value="Check2" id="Check2" name="select" required />
          <label class="form-check-label" for="Check2">Option 2</label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="checkbox" value="Check3" id="Check3" name="select" required />
