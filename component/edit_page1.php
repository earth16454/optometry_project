  ...
  <div class="card-body">
    ...
    <div class="row mb-3 g-3">
      <div class="col-12 col-md-6">
        ...
        <input type="text" name="pi_fname" id="pi_fname" value="<?php echo $pi_firstname; ?>" class="form-control" required />
      ...
      <div class="col-12 col-md-6">
        ...
        <input type="text" name="pi_lname" id="pi_lname" class="form-control" value="<?php echo $pi_lastname; ?>" required />
        <div class="invalid-feedback">
          Please complete the information.
        </div>
      </div>
      <div class="col-12 col-md-6">
        ...
        <input type="date" name="pi_birth" id="pi_birth" class="form-control" value="<?php echo $pi_birthdate; ?>" required />
      </div>

      <div class="col-12 col-md-6">
        <label for="pi_gender" class="form-label me-2">Gender :</label><br />
        <div class="form-check form-check-inline">
          <input type="radio" name="pi_gender" id="male" class="form-check-input" value="male" required />
        ...
        <div class="form-check form-check-inline">
          <input type="radio" name="pi_gender" id="other" class="form-check-input" value="LGBTQ+" />
      ...
      <div class="col-12 col-md-6">
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control" name="pi_tel" id="pi_tel" maxlength="10" value="<?php echo $pi_tel; ?>" placeholder="0999999999" required />
        </div>
      </div>
      <div class="col-12 col-md-6">
        <label for="pi_occupation" class="form-label">Occupation :</label>
        <div class="input-group mb-3">
          <input type="text" name="pi_occupation" id="pi_occupation" class="form-control" value="<?php echo $pi_occupation; ?>" required />
        </div>
      </div>
      ...
      <div class="col-12">
        ...
        <div class="col-sm-12">
          <textarea rows="3" name="pi_address" id="pi_address" class="form-control" required><?php echo $pi_address; ?></textarea>
        </div>
      </div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-3">
        <div class="form-check">
          <input class="form-check-input" type="radio" name="cc_symptoms" id="cc_symptoms1" value="มีอาการมัวระยะไกล" required />
          <label class="form-check-label" for="cc_symptoms1">มีอาการมัวระยะไกล</label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="cc_symptoms" id="cc_symptoms2" value="มีอาการมัวระยะใกล้" />
    ...
    <div class="row mb-3">
      ...
      <div class="col-md-4">
        ...
        <input type="radio" name="POHx_mydriatic" id="POHx_mydriatic1" class="form-check-input" value="yes" required />
    ...
    <div class="row mb-3">
      <div class="col-sm-3">
        <input class="form-check-input" type="radio" name="POHx_radio" id="POHx_radio1" onchange="toggleInput(this)" value="Glasses" required />
        <label class="form-check-label" for="POHx_radio1"> Glasses : </label>
      </div>
      <div class="col-sm-9" id="radioGroup">
        <input type="text" class="form-control" name="POHx_radio_detail" id="input1" disabled required />
      </div>
    </div>
    <div class="row mb-3">
      <div class="col-sm-3">
      ...
      <div class="col-sm-9" id="radioGroup">
        <input type="text" class="form-control" name="POHx_radio_detail" id="input2" disabled required />
      </div>
    </div>
    <div class="row mb-3">
      <div class="col-sm-3">
      ...
      <div class="col-sm-9" id="radioGroup">
        <input type="text" class="form-control" name="POHx_radio_detail" id="input3" disabled required />
      </div>
    </div>
    <div class="row mb-3">
      <div class="col-sm-3">
      ...
      <div class="col-sm-9" id="radioGroup">
        <input type="text" class="form-control" name="POHx_radio_detail" id="input4" disabled required />
      </div>
    </div>
    <div class="row mb-3">
      <div class="col-sm-3">
      ...
      <div class="col-sm-9" id="radioGroup">
        <input type="text" class="form-control" name="POHx_radio_detail" id="input5" disabled required />
      </div>
    </div>
    <div class="row mb-3">
      <div class="col-sm-3">
      ...
      <div class="col-sm-9" id="radioGroup">
        <input type="text" class="form-control" name="POHx_radio_detail" id="input6" disabled required />
      </div>
    </div>
    <hr />
    <div class="row mb-3">
    ...
    <div class="row mb-3">
      <div class="col-sm-3">
        <input class="form-check-input" type="radio" name="ha_radio" id="radio7" onchange="toggleInput2(this)" value="HA" required />
        <label class="form-check-label" for="radio7"> HA : </label>
      </div>
      <div class="col-sm-9" id="radioGroup2">
        <input type="text" class="form-control" name="ha_radio_detail" id="input7" disabled required />
      </div>
    </div>
    <div class="row mb-3">
      <div class="col-sm-3">
        <input class="form-check-input" type="radio" name="ha_radio" id="radio8" onchange="toggleInput2(this)" value="Diplopia" />
        <label class="form-check-label" for="radio8">
          Diplopia :
        </label>
      </div>
      <div class="col-sm-9" id="radioGroup2">
        <input type="text" class="form-control" name="ha_radio_detail" id="input8" disabled required />
      </div>
    </div>
    <div class="row mb-3">
      <div class="col-sm-3">
        <input class="form-check-input" type="radio" name="ha_radio" id="radio9" onchange="toggleInput2(this)" value="Flash" />
        <label class="form-check-label" for="radio9"> Flash : </label>
      </div>
      <div class="col-sm-9" id="radioGroup2">
        <input type="text" class="form-control" name="ha_radio_detail" id="input9" disabled required />
      </div>
    </div>
    <div class="row mb-3">
      <div class="col-sm-3">
        <input class="form-check-input" type="radio" name="ha_radio" id="radio10" onchange="toggleInput2(this)" value="Floater" />
        <label class="form-check-label" for="radio10"> Floater : </label>
      </div>
      <div class="col-sm-9" id="radioGroup2">
        <input type="text" class="form-control" name="ha_radio_detail" id="input10" disabled required />
      </div>
    </div>
    <div class="row mb-3">
      <div class="col-sm-3">
        <input class="form-check-input" type="radio" name="ha_radio" id="radio11" onchange="toggleInput2(this)" value="Halos" />
        <label class="form-check-label" for="radio11"> Halos : </label>
      </div>
      <div class="col-sm-9" id="radioGroup2">
        <input type="text" class="form-control" name="ha_radio_detail" id="input11" disabled required />
      </div>
    </div>
    <hr class="my-4" />
    <div class="row mb-3">
    ...
    <div class="row gy-3 mb-3">
      ...
      <div class="col-sm-10">
        <div class="form-check">
          <input class="form-check-input" type="radio" name="med_radio" id="radio12" onchange="toggleInput3(this)" value="Med" required />
          <label class="form-check-label" for="radio12"> Med </label>
          <div class="col-sm-12" id="radioGroup3">
            <input type="text" name="med_radio_detail" class="form-control" id="input12" disabled required />
          </div>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="med_radio" id="radio13" onchange="toggleInput3(this)" value="OTC" />
          <label class="form-check-label" for="radio13"> OTC </label>
          <div class="col-sm-12" id="radioGroup3">
            <input type="text" name="med_radio_detail" class="form-control" id="input13" disabled required />
          </div>
        </div>
      </div>
    ...
    <div class="row mb-3">
      <div class="col-md-4">
        <label for="inputText" class="col-sm-12 col-form-label"><b>อาชีพ/งานอดิเรก/การใช้อุปกรณ์อิเล็กทรอนิกส์</b></label>
      </div>
      <div class="col-md-4">
    ...
    <div class="row mb-3">
      <div class="col-md-6">
        <input class="form-check-input" type="checkbox" name="ohe_checkbox1" id="checkbox30" value="Computer (Laptop / PC)" onclick="toggleInput6(this)" />
        <label for="checkbox30" class="form-label">Computer (Laptop / PC) :</label>
        <div class="input-group mb-3" id="checkbox1Group1">
          <input type="text" name="ohe_checkbox_detail1" class="form-control" id="input30" disabled required />
        </div>
      </div>
      <div class="col-md-6">
        <input class="form-check-input" type="checkbox" name="ohe_checkbox2" id="checkbox31" value="Tablet/Smartphone" onclick="toggleInput6(this)" />
        <label for="checkbox31" class="form-label">Tablet/Smartphone :</label>
        <div class="input-group mb-3" id="checkbox1Group1">
          <input type="text" name="ohe_checkbox_detail2" class="form-control" id="input31" disabled required />
        </div>
      </div>
    </div>
    <div class="row mb-3">
      <div class="col-md-6">
        <input class="form-check-input" type="checkbox" name="ohe_checkbox3" id="checkbox32" value="Smoking" onclick="toggleInput6(this)" />
        <label for="checkbox32" class="form-label">Smoking :</label>
        <div class="input-group mb-3">
          <input type="text" name="ohe_checkbox_detail3" class="form-control" id="input32" disabled required />
        </div>
      </div>
      <div class="col-md-6">
        <input class="form-check-input" type="checkbox" name="ohe_checkbox4" id="checkbox33" value="Alcohol" onclick="toggleInput6(this)" />
        <label for="checkbox33" class="form-label">Alcohol :</label>
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="ohe_checkbox_detail4" id="input33" disabled required />
        </div>
      </div>
    </div>
    <hr />
    <div class="row mb-3">
      ...
      <div class="col-sm-10">
        <div class="form-check">
          <input class="form-check-input" type="radio" name="pr_radio" id="pr_radio1" value="1x" required />
          <label class="form-check-label" for="pr_radio1"> 1x </label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="pr_radio" id="pr_radio2" value="2x" />
          <label class="form-check-label" for="pr_radio2"> 2x </label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="pr_radio" id="pr_radio3" value="3x" />
          <label class="form-check-label" for="pr_radio3"> 3x </label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="pr_radio" id="pr_radio4" value="4x" />
